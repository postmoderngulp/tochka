...
abstract class TextStylee {
  ...
  static TextStyle buttonTxtStyle = TextStyle(
      color: Colors.white, fontFamily: "SfProMedium", fontSize: 16.sp);

  static TextStyle titleRegularGroup = TextStyle(
      color: colors.neutral800, fontFamily: "SoraSemiBold", fontSize: 12.sp);
  ...
  static TextStyle neutral800Txt = TextStyle(
      color: colors.neutral800, fontFamily: "GeometriaMedium", fontSize: 12.sp);
